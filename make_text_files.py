...
for ds in [1,2,3,4,5,6,7,11,12]:
  ...
  gt_dir = "/projects/mines/Josh/mines_ground_truth/sonar/range5000/{}".format(ds)
  ...
  with open("/projects/mines/Josh/mines_file_names/sonar_ds_{}_list.txt".format(ds), "w") as f:
